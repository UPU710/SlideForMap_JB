...
filePath <-  "/Users/julien/Dropbox/HAFL/03_SlideForMap/"     # the input path
outPath <- "/Users/julien/Dropbox/HAFL/03_SlideForMap/Output/"     # the output path
...
slidevariablenames <- c("latitude", "longitude", "mmacht", "anrissflaeche", "rutschneigung")  # w. vom File Hangmuren_Daten_Final.csv
